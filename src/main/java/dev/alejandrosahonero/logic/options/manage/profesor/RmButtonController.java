...
public class RmButtonController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            int confirm = JOptionPane.showConfirmDialog(modProView, "¿Seguro que desea eliminar el Profesor con DNI: " + s_dni + "?", "¡Cuidado!", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION){
                ...
                em.getTransaction().commit();
                em.close();
                JOptionPane.showMessageDialog(modProView, "Se canceló la eliminación", "¡Eliminación cancelada!", JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception ex) {
